...
//   baseURL: process.env.REACT_APP_API_URL || "https://agrighar-farmtofresh.onrender.com",
...
const API = axios.create({
  baseURL: import.meta.env.VITE_API_URL || "https://agrighar-farmtofresh.onrender.com/api",
  headers: {
