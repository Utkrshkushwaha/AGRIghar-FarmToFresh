...
const PRODUCT_IMAGE_MAP = [
  // Vegetables
  { keywords: ["tomato"],    img: "https://images.unsplash.com/photo-1546094096-0df4bcaaa337?w=400&h=300&fit=crop" },
  { keywords: ["spinach","palak"], img: "https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=400&h=300&fit=crop" },
  { keywords: ["onion"],     img: "https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=400&h=300&fit=crop" },
  { keywords: ["potato","aloo"], img: "https://images.unsplash.com/photo-1587735243615-c03f25aaff15?w=400&h=300&fit=crop" },
  { keywords: ["carrot"],    img: "https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=400&h=300&fit=crop" },
  { keywords: ["cabbage"],   img: "https://images.unsplash.com/photo-1594282486552-05b4d80fbb9f?w=400&h=300&fit=crop" },
  { keywords: ["brinjal","eggplant","baingan"], img: "https://images.unsplash.com/photo-1615484477778-ca3b77940c25?w=400&h=300&fit=crop" },
  { keywords: ["cauliflower","gobi"], img: "https://images.unsplash.com/photo-1568584711075-3d021a7c3ca3?w=400&h=300&fit=crop" },
  { keywords: ["cucumber","kheera"], img: "https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=400&h=300&fit=crop" },
  { keywords: ["pea","matar"], img: "https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=400&h=300&fit=crop" },
  // Fruits
  { keywords: ["mango","aam"],  img: "https://images.unsplash.com/photo-1553279768-865429fa0078?w=400&h=300&fit=crop" },
  ...
  { keywords: ["grape","angur"],img: "https://images.unsplash.com/photo-1537640538966-79f369143f8f?w=400&h=300&fit=crop" },
  { keywords: ["orange","santra"], img: "https://images.unsplash.com/photo-1547514701-42782101795e?w=400&h=300&fit=crop" },
  { keywords: ["papaya"],       img: "https://images.unsplash.com/photo-1526318896980-cf78c088247c?w=400&h=300&fit=crop" },
  { keywords: ["pomegranate","anar"], img: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=400&h=300&fit=crop" },
  { keywords: ["watermelon","tarbooz"], img: "https://images.unsplash.com/photo-1563114773-84221bd62daa?w=400&h=300&fit=crop" },
  { keywords: ["pineapple","ananas"], img: "https://images.unsplash.com/photo-1550258987-190a2d41a8ba?w=400&h=300&fit=crop" },
  { keywords: ["guava","amrood"], img: "https://images.unsplash.com/photo-1536511132770-e5058c7e8c46?w=400&h=300&fit=crop" },
  // Grains
  ...
  { keywords: ["corn","maize","makka"], img: "https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=400&h=300&fit=crop" },
  { keywords: ["dal","lentil","pulse"], img: "https://images.unsplash.com/photo-1585996160832-5b8e0b4e8b8e?w=400&h=300&fit=crop" },
  // Dairy
  { keywords: ["milk","doodh"],  img: "https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400&h=300&fit=crop" },
  { keywords: ["paneer","cheese"],img: "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=400&h=300&fit=crop" },
  { keywords: ["ghee","butter"], img: "https://images.unsplash.com/photo-1559598467-f8b76c8155d0?w=400&h=300&fit=crop" },
  { keywords: ["curd","yogurt","dahi"], img: "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400&h=300&fit=crop" },
  // Spices
  { keywords: ["turmeric","haldi"], img: "https://images.unsplash.com/photo-1615485500704-8e990f9900f7?w=400&h=300&fit=crop" },
  { keywords: ["chilli","chili","mirch"], img: "https://images.unsplash.com/photo-1583119022894-919a68a3d0e3?w=400&h=300&fit=crop" },
  { keywords: ["coriander","dhania"], img: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=400&h=300&fit=crop" },
  { keywords: ["ginger","adrak"], img: "https://images.unsplash.com/photo-1615485291234-9d694218aeb3?w=400&h=300&fit=crop" },
  { keywords: ["garlic","lahsun"], img: "https://images.unsplash.com/photo-1540148426945-6cf22a6b2383?w=400&h=300&fit=crop" },
];
...
// Smart image picker — matches product name keywords first, then category fallback
